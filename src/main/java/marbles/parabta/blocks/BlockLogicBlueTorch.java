...
public class BlockLogicBlueTorch extends BlockLogic {
	...
	public BlockLogicBlueTorch(Block<?> block) {
	...
	public void animationTick(World world, int x, int y, int z, Random rand) {
		...
		switch (side) {
			case 1:
				...
				world.spawnParticle("blue_flame", xPos - d4, yPos + d3, zPos, 0.0, 0.0, 0.0, 0);
				break;
			case 2:
				world.spawnParticle("smoke", xPos + d4, yPos + d3, zPos, 0.0, 0.0, 0.0, 0);
				world.spawnParticle("blue_flame", xPos + d4, yPos + d3, zPos, 0.0, 0.0, 0.0, 0);
			...
			case 3:
				...
				world.spawnParticle("blue_flame", xPos, yPos + d3, zPos - d4, 0.0, 0.0, 0.0, 0);
				break;
			case 4:
				world.spawnParticle("smoke", xPos, yPos + d3, zPos + d4, 0.0, 0.0, 0.0, 0);
				world.spawnParticle("blue_flame", xPos, yPos + d3, zPos + d4, 0.0, 0.0, 0.0, 0);
			...
			case 5:
				...
				world.spawnParticle("blue_flame", xPos, yPos, zPos, 0.0, 0.0, 0.0, 0);
		}
